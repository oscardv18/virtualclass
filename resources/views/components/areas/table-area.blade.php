        ...
        <x-dashboard.main-template>
            <x-slot name="content">
                <div class="flex items-center py-4 overflow-y-auto whitespace-nowrap">
                    ...
                    <a href="{{ route('table-area') }}" class="text-gray-600 dark:text-gray-200 hover:underline">
                        Carreras
                    </a>
                    ...
                    <a href="{{ route('table-area') }}" class="text-blue-600 dark:text-blue-400 hover:underline">
                        Administrar
                    </a>
                </div>
                <div class="col-span-12 mt-5">
                    <div class="grid grid-cols-1 gap-2 lg:grid-cols-1">
                        @livewire('areas.table-area')
                    </div>
                </div>
            </x-slot>
        </x-dashboard.main-template>
