                ...
                <li class="relative">
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            <button class="p-2 text-green-400 align-middle bg-white rounded-full hover:text-white hover:bg-green-400 focus:outline-none " aria-label="Account" aria-haspopup="true">
