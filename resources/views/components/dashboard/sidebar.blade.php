<div>
    ...
    <div class="flex h-full space-x-6 bg-white">
        {{-- <!-- Component Start -->
        <div class="md:flex flex-col items-center w-16 h-full overflow-hidden text-gray-700 bg-white rounded sm:hidden">
        ...
        <!-- Component Start -->
        <div class="lg:flex md:hidden sm:hidden flex-col items-center w-40 h-full overflow-hidden text-gray-700 bg-white rounded">
            <a class="flex items-center w-full px-2 py-1 mt-3" href="#">
                ...
                <span class="ml-2 text-sm font-bold">{{ __("Virtualclass") }}</span>
            </a>
            <div class="w-full px-2">
                <div class="flex flex-col items-center w-full mt-3 border-t border-gray-300">
                    ...
                    <a class="flex items-center w-full h-12 px-3 mt-2 bg-red-500 rounded" href="#">
                        <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
