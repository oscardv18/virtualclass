                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <a class="col-span-12 transition duration-300 transform bg-white rounded-lg shadow-xl hover:scale-105 sm:col-span-6 xl:col-span-3 intro-y"
                            ...
                            <div class="p-5">
                                ...
                                <div class="flex-1 w-full ml-2">
                                    <div>
                                        <div class="mt-3 text-2xl font-bold leading-8">Instituciones</div>

                                        <div class="mt-1 text-base text-gray-600">¿Dónde estudio?</div>
                                    </div>
                                </div>
                            </div>
                        </a>
                        <a class="col-span-12 transition duration-300 transform bg-white rounded-lg shadow-xl hover:scale-105 sm:col-span-6 xl:col-span-3 intro-y"
                            ...
                            <div class="p-5">
                                ...
                                <div class="flex-1 w-full ml-2">
                                    <div>
                                        <div class="mt-3 text-2xl font-bold leading-8">Publicaciones</div>

                                        <div class="mt-1 text-base text-gray-600">Mira tus publicaciones</div>
                                    </div>
                                </div>
                            </div>
                        </a>
                        <a class="col-span-12 transition duration-300 transform bg-white rounded-lg shadow-xl hover:scale-105 sm:col-span-6 xl:col-span-3 intro-y"
                            ...
                            <div class="p-5">
                                <div class="flex justify-between">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="text-pink-600 h-7 w-7" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="flex-1 w-full ml-2">
                                    <div>
                                        <div class="mt-3 text-2xl font-bold leading-8">Asignaturas</div>

                                        <div class="mt-1 text-base text-gray-600">Explorar mis Clases</div>
                                    </div>
                                </div>
                            </div>
                        </a>
                        <a class="col-span-12 transition duration-300 transform bg-white rounded-lg shadow-xl hover:scale-105 sm:col-span-6 xl:col-span-3 intro-y"
                            ...
                            <div class="p-5">
                                <div class="flex justify-between">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="text-green-400 h-7 w-7" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="flex-1 w-full ml-2">
                                    <div>
                                        <div class="mt-3 text-2xl font-bold leading-8">Evaluaciones</div>

                                        <div class="mt-1 text-base text-gray-600">¿Cómo voy en mis clases?</div>
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="grid grid-cols-1 gap-2 lg:grid-cols-1">
                        <div class="p-4 bg-white rounded-lg shadow-lg">
                            <div class="w-full flex flex-col items-center">
                                <h1 class="text-base font-bold ">Actividades y Evaluaciones</h1>
                            </div>
                            <div class="mt-4">
