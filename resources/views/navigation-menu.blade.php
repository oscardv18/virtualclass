    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <!-- Settings Dropdown -->
                {{-- Codigo editado por mi, agregada la condicion de auth para evitar error de foto de perfil --}}
                <div class="ml-3 relative">
                    @auth
                    ...
                    @else
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-jet-nav-link class="text-pink-700" href="{{ route('login') }}"
                                :active="request()->routeIs('login')">
                                {{ __('Login') }}
                            </x-jet-nav-link>
                            <x-jet-nav-link class="text-pink-700" href="{{ route('register') }}"
